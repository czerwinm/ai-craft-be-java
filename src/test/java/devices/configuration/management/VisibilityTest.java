...
class VisibilityTest {
    ...
    void shouldHaveRoamingEnabledOnlyWhenUsable() {
        // Given - usable device
        Violations noViolations = Violations.builder()
                .operatorNotAssigned(false)
                .providerNotAssigned(false)
                .locationMissing(false)
                .showOnMapButMissingLocation(false)
        ...
        Violations withViolations = Violations.builder()
                .operatorNotAssigned(true)
                .providerNotAssigned(false)
                .locationMissing(false)
                .showOnMapButMissingLocation(false)
    ...
    void shouldCalculateCorrectlyForAllCombinations() {
        ...
        // No violations, no public access, show on map -> INACCESSIBLE_AND_HIDDEN_ON_MAP
        ...
        // No violations, no public access, no show on map -> INACCESSIBLE_AND_HIDDEN_ON_MAP
        ...
        // With violations - always INACCESSIBLE_AND_HIDDEN_ON_MAP regardless of other settings
        Violations withViolations = Violations.builder()
                .operatorNotAssigned(true)
                .providerNotAssigned(false)
                .locationMissing(false)
