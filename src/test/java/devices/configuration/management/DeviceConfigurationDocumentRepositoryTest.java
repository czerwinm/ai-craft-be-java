...
class DeviceConfigurationDocumentRepositoryTest {
    ...
    void shouldSaveAndRetrieveDevice() {
        ...
        assertThat(retrieved.get().device().toSnapshot().ownership()).isEqualTo(Ownership.of("operator1", "provider1"));
    ...
    void shouldUpdateDeviceWithOptimisticLocking() {
        ...
        assertThat(updated.device().toSnapshot().ownership()).isEqualTo(Ownership.of("operator2", "provider2"));
    }
    ...
    void shouldEmitDomainEvents() {
        ...
        device.changeLocation(Location.of(
                "Street", "1", "City", "00-000", "State", "Country",
        ...
        // Then
        assertThat(events.stream(DomainEvent.class).toList())
