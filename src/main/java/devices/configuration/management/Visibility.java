...
public record Visibility(ForCustomer forCustomer, boolean roamingEnabled) {
   ...
   */
  public static Visibility calculateFrom(
      Violations violations, boolean publicAccess, boolean showOnMap) {
