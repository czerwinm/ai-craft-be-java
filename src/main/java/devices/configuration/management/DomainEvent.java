...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = DomainEvent.OpeningHoursChanged.class, name = "OpeningHoursChanged_v1"),
        @JsonSubTypes.Type(value = DomainEvent.SettingsChanged.class, name = "SettingsChanged_v1"),
        @JsonSubTypes.Type(value = DomainEvent.DeviceConfigurationChanged.class, name = "DeviceConfigurationChanged_v1")
})
